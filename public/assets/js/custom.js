...
try {
    ...
    function getTrElement(tblName,tr){trContainer=$('<div></div>');trInfo=$('#'+tblName).DataTable().row(tr).data();$.each(trInfo,function(index,trInfoRow){trContainer.append(trInfoRow);});return trContainer;}
