!(function (t, e) {
      ...
      trigger(t, e, i) {
        ...
        return (
          o &&
            ...
            (h = !r.isImmediatePropagationStopped()),
  ...
  class X extends W {
    ...
    toggle() {
      this._element.setAttribute(
        "aria-pressed",
        this._element.classList.toggle(Q)
      );
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  class $t extends W {
    ...
    pause(e) {
      e || (this._isPaused = !0),
        t.findOne(Ft, this._element) && (o(this._element), this.cycle(!0)),
    ...
    to(e) {
      ...
      if (this._isSliding)
        return void L.one(this._element, ut, () => this.to(e));
    ...
    _addEventListeners() {
      this._config.keyboard && L.on(this._element, dt, (t) => this._keydown(t)),
        "hover" === this._config.pause &&
          (L.on(this._element, pt, (t) => this.pause(t)),
          L.on(this._element, ft, (t) => this.cycle(t))),
        this._config.touch &&
          this._touchSupported &&
    ...
    _addTouchEventListeners() {
      const e = (t) => {
          !this._pointerEvent || (t.pointerType !== Nt && t.pointerType !== Lt)
        ...
        s = (t) => {
          !this._pointerEvent ||
            (t.pointerType !== Nt && t.pointerType !== Lt) ||
      ...
      t.find(Pt, this._element).forEach((t) => {
        ...
        this._pointerEvent
          ? (L.on(this._element, _t, (t) => e(t)),
            L.on(this._element, bt, (t) => s(t)),
            this._element.classList.add(At))
          : (L.on(this._element, gt, (t) => e(t)),
            L.on(this._element, mt, (t) => i(t)),
            L.on(this._element, vt, (t) => s(t)));
    }
    _keydown(t) {
    ...
    _getItemIndex(e) {
      return (
        (this._items = e && e.parentNode ? t.find(Mt, e.parentNode) : []),
    ...
    _triggerSlideEvent(e, i) {
      ...
      return L.trigger(this._element, ct, {
        relatedTarget: e,
        direction: i,
        from: n,
        to: s,
    ...
    static dataApiClickHandler(t) {
      ...
      s && (i.interval = !1),
        $t.carouselInterface(e, i),
        s && $t.getInstance(e).to(s),
        t.preventDefault();
    }
  }
  L.on(
    ...
    L.on(window, "load.bs.carousel.data-api", () => {
      ...
      for (let t = 0, i = e.length; t < i; t++)
        $t.carouselInterface(e[t], $t.getInstance(e[t]));
    }),
    v($t);
  const Ht = "collapse",
    Wt = "bs.collapse",
  ...
  class se extends W {
    constructor(e, i) {
      super(e),
        ...
        (this._triggerArray = t.find(
          `${ie}[href="#${this._element.id}"],` +
            `${ie}[data-bs-target="#${this._element.id}"]`
        ));
      const n = t.find(ie);
    ...
    hide() {
      ...
      (this._element.style[t] = `${
        ...
        p(this._element),
        this._element.classList.add(Zt),
        this._element.classList.remove(Xt, Qt);
      ...
      if (e > 0)
        for (let t = 0; t < e; t++) {
          const e = this._triggerArray[t],
            i = n(e);
          i &&
            !i.classList.contains(Qt) &&
            (e.classList.add(Gt), e.setAttribute("aria-expanded", !1));
        }
      this.setTransitioning(!0);
      (this._element.style[t] = ""),
        this._queueCallback(
    ...
    _getConfig(t) {
      return (
        ((t = { ...jt, ...t }).toggle = Boolean(t.toggle)), l(Ht, t, qt), t
      );
    }
    _getDimension() {
    ...
    _addAriaAndCollapsedClass(t, e) {
      ...
      e.forEach((t) => {
        i ? t.classList.remove(Gt) : t.classList.add(Gt),
  ...
  function Ce(t) {
    return (
      ...
      (t instanceof ye(t).ShadowRoot || t instanceof ShadowRoot)
    );
  }
  var ke = {
    name: "applyStyles",
  ...
  function Me(t) {
    return (
      (we(t) ? t.ownerDocument : t.document) || window.document
    ).documentElement;
  }
  function Pe(t) {
    return "html" === be(t)
      ? t
      : t.assignedSlot || t.parentNode || (Ce(t) ? t.host : null) || Me(t);
  }
  function Fe(t) {
    return xe(t) && "fixed" !== Se(t).position ? t.offsetParent : null;
  }
  function Oe(t) {
    for (var e = ye(t), i = Fe(t); i && Te(i) && "static" === Se(i).position; )
      i = Fe(i);
    return i &&
      ("html" === be(i) || ("body" === be(i) && "static" === Se(i).position))
      ? e
      : i ||
          (function (t) {
      ...
      : si(
          (function (t) {
            var e,
              ...
              l = -s.scrollTop;
            return (
              "rtl" === Se(n || i).direction &&
                (r += Le(i.clientWidth, n ? n.clientWidth : 0) - o),
    ...
    var s =
        "clippingParents" === e
          ? (function (t) {
              var e = ii(Pe(t)),
                i =
                  ["absolute", "fixed"].indexOf(Se(t).position) >= 0 && xe(t)
                    ? Oe(t)
                    : t;
              return we(i)
                ? e.filter(function (t) {
          ...
          return (
            (t[i] = (function (t, e, i) {
              ...
              return (
                (a = a || 0),
                (r = (r || 0) * n),
                [re, ae].indexOf(s) >= 0 ? { x: r, y: a } : { x: a, y: r }
              );
            })(i, e.rects, o)),
            t
          );
        ...
        (("body" !== be(e) || ei(o)) &&
          (l =
            (s = e) !== ye(s) && xe(s)
              ...
              : Je(s)),
        xe(e)
          ? (((h = Ee(e)).x += e.clientLeft), (h.y += e.clientTop))
          : o && (h.x = ti(o))),
      {
      ...
      var n,
        ...
        c = {
          ...
          setOptions: function (i) {
            u(),
              (r.options = Object.assign({}, o, r.options, i)),
              (r.scrollParents = {
                reference: we(t)
                  ? ii(t)
                  : t.contextElement
          ...
          forceUpdate: function () {
            if (!h) {
              ...
              if (yi(e, i)) {
                (r.rects = {
                  reference: vi(e, Oe(i), "fixed" === r.options.strategy),
                  popper: Ie(i),
                }),
                  (r.reset = !1),
                ...
                for (var s = 0; s < r.orderedModifiers.length; s++)
                  if (!0 !== r.reset) {
                    ...
                    "function" == typeof o &&
                      (r =
                        o({ state: r, options: l, name: u, instance: c }) || r);
                  } else (r.reset = !1), (s = -1);
              }
            }
          },
  ...
  class is extends W {
    ...
    show() {
      ...
      if (!L.trigger(this._element, Li, e).defaultPrevented) {
        if (this._inNavbar) J.setDataAttribute(this._menu, "popper", "none");
          ...
          (this._popper = ki(e, this._menu, i)),
            s && J.setDataAttribute(this._menu, "popper", "static");
        }
        "ontouchstart" in document.documentElement &&
          !t.closest(Vi) &&
          []
    ...
    static clearMenus(e) {
      if (e && (e.button === Pi || ("keyup" === e.type && e.key !== Si)))
        return;
      const i = t.find(Bi);
    ...
    static dataApiKeydownHandler(e) {
      if (
        /input|textarea/i.test(e.target.tagName)
          ? e.key === Ai ||
            (e.key !== Ii &&
              ((e.key !== Mi && e.key !== Ti) || e.target.closest(Yi)))
          : !Fi.test(e.key)
      )
        return;
      ...
      return e.key === Ii
        ? (s().focus(), void is.clearMenus())
        : e.key === Ti || e.key === Mi
        ? (i || s().click(), void is.getInstance(s())._selectMenuItem(e))
        : void ((i && e.key !== Ai) || is.clearMenus());
    }
  }
  ...
  class os {
    ...
    hide() {
      ...
      this._disableOverFlow(),
        ...
        this._setElementAttributes(ss, "paddingRight", (e) => e + t),
        this._setElementAttributes(ns, "marginRight", (e) => e - t);
    }
    _disableOverFlow() {
    ...
    reset() {
      this._resetElementAttributes(this._element, "overflow"),
        ...
        this._resetElementAttributes(ss, "paddingRight"),
        this._resetElementAttributes(ns, "marginRight");
    }
  ...
  class ps {
    ...
    _getElement() {
      if (!this._element) {
        ...
        (t.className = hs),
          this._config.isAnimated && t.classList.add(cs),
          (this._element = t);
      }
    ...
    _getConfig(t) {
      return (
        ((t = { ...as, ...("object" == typeof t ? t : {}) }).rootElement = r(
          t.rootElement
        )),
        l(ls, t, rs),
        t
  ...
  class $s extends W {
    ...
    dispose() {
      [window, this._dialog].forEach((t) => L.off(t, gs)),
      ...
      this._queueCallback(
        () => {
          this._config.focus && this._element.focus(),
            (this._isTransitioning = !1),
            L.trigger(this._element, Cs, { relatedTarget: e });
        },
        this._dialog,
        i
      );
    ...
    _setEscapeEvent() {
      this._isShown
        ? L.on(this._element, Is, (t) => {
            this._config.keyboard && t.key === ms
    ...
    _setResizeEvent() {
      this._isShown
        ? L.on(window, Ds, () => this._adjustDialog())
        : L.off(window, Ds);
    }
    _hideModal() {
      (this._element.style.display = "none"),
        ...
        (this._isTransitioning = !1),
        this._backdrop.hide(() => {
          document.body.classList.remove(Ms),
            this._resetAdjustments(),
            this._scrollBar.reset(),
            L.trigger(this._element, ws);
        });
    }
    _showBackdrop(t) {
  ...
  class Gs extends W {
    ...
    show(t) {
      ...
      if (L.trigger(this._element, Bs, { relatedTarget: t }).defaultPrevented)
        return;
      (this._isShown = !0),
        (this._element.style.visibility = "visible"),
        this._backdrop.show(),
        this._config.scroll ||
          (new os().hide(), this._enforceFocusOnElement(this._element)),
        this._element.removeAttribute("aria-hidden"),
        this._element.setAttribute("aria-modal", !0),
        this._element.setAttribute("role", "dialog"),
  ...
  L.on(
    ...
    function (e) {
      ...
      s && s !== i && Gs.getInstance(s).hide(),
        Gs.getOrCreateInstance(i).toggle(this);
    }
  ),
    L.on(window, "load.bs.offcanvas.data-api", () =>
      t.find(".offcanvas.show").forEach((t) => Gs.getOrCreateInstance(t).show())
    ),
    v(Gs);
  const Js = new Set([
      "background",
    ...
    sn = (t, e) => {
      ...
      if (e.includes(i))
        return (
          !Js.has(i) || Boolean(tn.test(t.nodeValue) || en.test(t.nodeValue))
        );
  ...
  class kn extends W {
    ...
    show() {
      ...
      $.set(n, this.constructor.DATA_KEY, this),
        ...
        this._popper
          ? this._popper.update()
          : (this._popper = ki(this._element, n, this._getPopperConfig(r))),
        n.classList.add(mn);
      const h =
    ...
    setContent() {
      ...
      this.setElementContent(t.findOne(bn, e), this.getTitle()),
        e.classList.remove(fn, mn);
    }
        ...
        return a(e)
          ...
          : void (this._config.html
              ? (this._config.sanitize &&
                  (e = on(e, this._config.allowList, this._config.sanitizeFn)),
                (t.innerHTML = e))
              : (t.textContent = e));
    }
    getTitle() {
    ...
    _initializeOnDelegatedTarget(t, e) {
      ...
      return (
        (e = e || $.get(t.delegateTarget, i)) ||
          ((e = new this.constructor(
            t.delegateTarget,
            this._getDelegateConfig()
          )),
          $.set(t.delegateTarget, i, e)),
        e
      );
    }
    _getOffset() {
    ...
    getTipElement() {
      return this.tip
        ...
        : ((this.tip = super.getTipElement()),
          this.getTitle() || t.findOne(Fn, this.tip).remove(),
          this._getContent() || t.findOne(On, this.tip).remove(),
          this.tip);
    }
    setContent() {
      const e = this.getTipElement();
      ...
      "function" == typeof i && (i = i.call(this._element)),
        this.setElementContent(t.findOne(On, e), i),
        e.classList.remove(Mn, Pn);
    }
    _addAttachmentClass(t) {
  ...
  class mo extends W {
    ...
    show() {
      ...
      if (
        L.trigger(this._element, so, { relatedTarget: e }).defaultPrevented ||
        (null !== o && o.defaultPrevented)
      )
        return;
      this._activate(this._element, s);
      const a = () => {
        L.trigger(e, io, { relatedTarget: this._element }),
          L.trigger(this._element, no, { relatedTarget: e });
      };
    ...
    _transitionComplete(e, i, s) {
      ...
      e.classList.add(ao),
        ...
        p(e),
        e.classList.contains(ro) && e.classList.add(lo);
      let n = e.parentNode;
      if (
        (n && "LI" === n.nodeName && (n = n.parentNode),
        n && n.classList.contains(oo))
      ) {
        const i = e.closest(ho);
        i && t.find(fo, i).forEach((t) => t.classList.add(ao)),
  ...
  class Oo extends W {
    ...
    _getConfig(t) {
      return (
        ...
        l(vo, t, this.constructor.DefaultType),
        t
      );
    }
    _maybeScheduleHide() {
      ...
      (t.Widget.prototype = {
        ...
        _trigger: function (e, i, s) {
          ...
          return (
            ...
            !(
              (t.isFunction(a) && !1 === a.call(this.element[0], i, s)) ||
                ...
                if (
                  ...
                  if (n) {
                    ...
                    if (this.options.greedy) {
                      ...
                      a.length &&
                        ((o = t.data(a[0], "droppable")).greedyChild =
                          "isover" == n ? 1 : 0);
                    }
                    o &&
                      "isover" == n &&
  ...
  (function (t, e) {
    t.widget("ui.resizable", t.ui.mouse, {
      ...
      _mouseStart: function (e) {
        ...
        s.containment &&
          ((a += t(s.containment).scrollLeft() || 0),
      ...
      _respectSize: function (t, e) {
        ...
        var h = this.originalPosition.left + this.originalSize.width,
          ...
          u = /sw|nw|w/.test(n),
          d = /nw|ne|n/.test(n);
        r && u && (t.left = h - i.minWidth),
          o && u && (t.left = h - i.maxWidth),
          l && d && (t.top = c - i.minHeight),
          a && d && (t.top = c - i.maxHeight);
        ...
        stop: function (e, i) {
          ...
          s.element.animate(t.extend(h, u && c ? { top: u, left: c } : {}), {
            ...
            step: function () {
              ...
              o &&
                o.length &&
                t(o[0]).css({ width: i.width, height: i.height }),
                s._updateCache(i),
      ...
      t.ui.plugin.add("resizable", "grid", {
        resize: function (e, i) {
          ...
          var h =
              Math.round((o.width - a.width) / (n.grid[0] || 1)) *
              (n.grid[0] || 1),
            c =
              Math.round((o.height - a.height) / (n.grid[1] || 1)) *
              (n.grid[1] || 1);
          /^(se|s|e)$/.test(l)
            ? ((s.size.width = a.width + h), (s.size.height = a.height + c))
            : /^(ne)$/.test(l)
            ? ((s.size.width = a.width + h),
              (s.size.height = a.height + c),
  ...
  (function (t, e) {
    t.widget("ui.sortable", t.ui.mouse, {
        ...
        for (var n = this.items.length - 1; n >= 0; n--) {
          ...
          if (
            ...
            !(
              ...
              t.ui.contains(this.placeholder[0], a) ||
              ("semi-dynamic" == this.options.type &&
                t.ui.contains(this.element[0], a))
            )
          ) {
            if (
      ...
      _refreshItems: function (e) {
        ...
        for (o = s.length - 1; o >= 0; o--)
          for (
            var h = s[o][1], c = s[o][0], u = ((r = 0), c.length);
            r < u;
            r++
          ) {
            var d = t(c[r]);
      ...
      (t.effects.animateClass = function (e, i, s, a) {
                ...
                })(u, r),
                {
                  ...
                  complete: function () {
                    t.each(h, function (t, i) {
                      ...
                      "object" == typeof l.attr("style")
                        ? ((l.attr("style").cssText = ""),
                          (l.attr("style").cssText = c))
                        : l.attr("style", c),
        ...
        t.extend(t.easing, {
          ...
          easeInBack: function (t, i, s, n, o, a) {
            return (
              a == e && (a = 1.70158), n * (i /= o) * i * ((a + 1) * i - a) + s
            );
          },
  ...
  (function (t, e) {
    t.effects.bounce = function (e) {
      return this.queue(function () {
        ...
        ("show" == n && i.css("opacity", 0).css(h, "pos" == c ? -a : a),
        "hide" == n && (a /= 2 * r),
        "hide" != n && r--,
        "show" == n) &&
          (((p = { opacity: 1 })[h] = ("pos" == c ? "+=" : "-=") + a),
    ...
    t.effects.drop = function (e) {
      return this.queue(function () {
        ...
        var a = "up" == o || "down" == o ? "top" : "left",
          ...
          l =
            e.options.distance ||
            ("top" == a ? i.outerHeight(!0) / 2 : i.outerWidth(!0) / 2);
    ...
    t.effects.fold = function (e) {
      return this.queue(function () {
        ...
        (p[c[0]] = "show" == n ? u[0] : o),
          (f[c[1]] = "show" == n ? u[1] : 0),
          l
            .animate(p, r, e.options.easing)
            .animate(f, r, e.options.easing, function () {
              "hide" == n && i.hide(),
                t.effects.restore(i, s),
                t.effects.removeWrapper(i),
                e.callback && e.callback.apply(i[0], arguments),
    ...
    t.effects.pulsate = function (e) {
      return this.queue(function () {
        var i = t(this),
          ...
          a = i.is(":visible"),
          r = 0;
        a || (i.css("opacity", 0).show(), (r = 1)),
          (("hide" == s && a) || ("show" == s && !a)) && n--;
        for (var l = 0; l < n; l++)
          i.animate({ opacity: r }, o, e.options.easing), (r = (r + 1) % 2);
    ...
    t.effects.shake = function (e) {
      return this.queue(function () {
        ...
        (c[l] = ("pos" == h ? "-=" : "+=") + o),
          (u[l] = ("pos" == h ? "+=" : "-=") + 2 * o),
          (d[l] = ("pos" == h ? "-=" : "+=") + 2 * o),
          i.animate(c, r, e.options.easing);
        for (var p = 1; p < a; p++)
          i.animate(u, r, e.options.easing).animate(d, r, e.options.easing);
        i
          .animate(u, r, e.options.easing)
          .animate(c, r / 2, e.options.easing, function () {
            t.effects.restore(i, s),
              t.effects.removeWrapper(i),
              e.callback && e.callback.apply(this, arguments);
          }),
    ...
    t.effects.slide = function (e) {
      return this.queue(function () {
        ...
        var a = "up" == o || "down" == o ? "top" : "left",
          ...
          l =
            e.options.distance ||
            ("top" == a ? i.outerHeight(!0) : i.outerWidth(!0));
    ...
    t.widget("ui.accordion", {
      ...
      _toggle: function (e, i, s, n, o) {
        ...
        if (
          ...
          (a.running = 0 === i.size() ? e.size() : i.size()),
          r.animated)
        ) {
          var h = {};
          (h =
            ...
            (r.duration = t.isFunction(r.proxiedDuration)
              ? r.proxiedDuration(h)
              : r.proxiedDuration);
          ...
          (e.trigger = $(
            this._get(e, "buttonImageOnly")
              ...
              : $('<button type="button"></button>')
                  .addClass(this._triggerClass)
                  .html(
                    "" == a ? o : $("<img/>").attr({ src: a, alt: o, title: o })
                  )
          )),
          ...
          if (!1 !== s) {
            ...
            if (
              ...
              e.dpDiv.zIndex($(t).zIndex() + 1),
                ...
                $.effects && $.effects[a]
                  ? e.dpDiv.show(a, $.datepicker._get(e, "showOptions"), r, l)
                  : e.dpDiv[a || "show"](a ? r : null, l),
                (!a || !r) && l(),
                e.input.is(":visible") &&
                  !e.input.is(":disabled") &&
                  e.input.focus(),
            ...
            ? (function (e) {
                ...
                for (
                  ...
                  switch (r[2] || "d") {
                    ...
                    case "M":
                      (n += parseInt(r[1], 10)),
                        (o = Math.min(o, $.datepicker._getDaysInMonth(s, n)));
                      break;
                    case "y":
                    case "Y":
                      (s += parseInt(r[1], 10)),
      ...
      _generateHTML: function (t) {
        ...
        for (
          ...
          for (var N = 0; N < a[1]; N++) {
            ...
            this.maxRows = U;
            for (
              var Q = this._daylightSavingAdjust(new Date(f, p, 1 - V)), X = 0;
              X < U;
              X++
            ) {
              R += "<tr>";
              ...
              for (q = 0; q < 7; q++) {
                var G = T
                    ? T.apply(t.input ? t.input[0] : null, [Q])
                    : [!0, ""],
                  J = Q.getMonth() != p,
                ...
                (Z +=
                  ...
                  ((Q.getTime() == H.getTime() &&
                    p == t.selectedMonth &&
                    t._keyEvent) ||
                  (F.getTime() == Q.getTime() && F.getTime() == H.getTime())
                    ? " " + this._dayOverClass
                    : "") +
                  (tt
      ...
      _setOption: function (e, s) {
        ...
        switch (e) {
          ...
          case "resizable":
            ...
            r && !s && o.resizable("destroy"),
              r && "string" == typeof s && o.resizable("option", "handles", s),
              !r && !1 !== s && n._makeResizable(s);
            break;
          case "title":
        ...
        this.options.values && this.options.values.length
                ...
                !0 === l.options.range &&
                  ("horizontal" === l.orientation
                    ? (0 === s &&
                        l.range
                          .stop(1, 1)
                          [h ? "animate" : "css"]({ left: e + "%" }, r.animate),
                      1 === s &&
          ...
          : ((s = this.value()),
            ...
            "min" === a &&
              ...
              this.range
                .stop(1, 1)
                [h ? "animate" : "css"]({ width: e + "%" }, r.animate),
            "max" === a &&
              "horizontal" === this.orientation &&
            ...
            "min" === a &&
              ...
              this.range
                .stop(1, 1)
                [h ? "animate" : "css"]({ height: e + "%" }, r.animate),
            "max" === a &&
              "vertical" === this.orientation &&
              this.range[h ? "animate" : "css"](
                { height: 100 - e + "%" },
    ...
    t.widget("ui.tabs", {
      ...
      _tabify: function (i) {
        ...
        (this.list = this.element.find("ol,ul").eq(0)),
          ...
          this.anchors.each(function (e, i) {
            ...
            if (
              ...
              a.panels = a.panels.add(a.element.find(a._sanitizeSelector(n)));
            else if (n && "#" !== n) {
              ...
              c.length ||
                (c = t(r.panelTemplate)
                  ...
                  .insertAfter(a.panels[e - 1] || a.list)).data(
                  "destroy.tabs",
                  !0
                ),
          ...
          i
            ? (this.element.addClass(
              ...
              r.selected === e
                ? (location.hash &&
                  ...
                  "number" != typeof r.selected &&
                    r.cookie &&
                    (r.selected = parseInt(a._cookie(), 10)),
                  "number" != typeof r.selected &&
              ...
              r.selected >= 0 &&
                this.anchors.length &&
                (a.element
                  .find(a._sanitizeSelector(a.anchors[r.selected].hash))
                ...
                a.element.queue("tabs", function () {
                  a._trigger(
                    ...
                    null,
                    a._ui(
                      a.anchors[r.selected],
                      a.element.find(
                        a._sanitizeSelector(a.anchors[r.selected].hash)
                      )[0]
                    )
                  );
                }),
        ...
        for (var h, c = 0; (h = this.lis[c]); c++)
          t(h)[
            -1 == t.inArray(c, r.disabled) || t(h).hasClass("ui-tabs-selected")
              ? "removeClass"
              : "addClass"
          ]("ui-state-disabled");
        if (
        ...
        r.fx &&
          (t.isArray(r.fx) ? ((n = r.fx[0]), (o = r.fx[1])) : (n = o = r.fx));
        var p = o
            ? function (e, i) {
            ...
            : function (e, i) {
                t(e).closest("li").addClass("ui-tabs-selected ui-state-active"),
                  ...
                  a._trigger("show", null, a._ui(e, i[0]));
              },
          f = n
            ? function (t, e) {
        ...
        this.anchors.bind(r.event + ".tabs", function () {
          ...
          if (
            ...
            return this.blur(), !1;
          if (
            ((r.selected = a.anchors.index(this)), a.abort(), r.collapsible)
          ) {
          ...
          if ((r.cookie && a._cookie(r.selected, r.cookie), !n.length))
      ...
      add: function (i, s, n) {
        ...
        var o = this,
          a = this.options,
          r = t(
            a.tabTemplate.replace(/#\{href\}/g, i).replace(/#\{label\}/g, s)
          ),
        ...
        return (
          h.length ||
            (h = t(a.panelTemplate).attr("id", l).data("destroy.tabs", !0)),
          h.addClass(
            "ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide"
          ),
          n >= this.lis.length
            ? (r.appendTo(this.list), h.appendTo(this.list[0].parentNode))
            : (r.insertBefore(this.lis[n]), h.insertBefore(this.panels[n])),
    ...
    t.each("branch form header step wrapper".split(" "), function () {
      ...
      t.widget("kf.wizard", {
        ...
        _create: function () {
          ...
          c[0].elements
            ? (e = c)
            : (e = c.find("form")).length || (e = c.closest("form")),
            ...
            for (o = 0, r = (e = a(e)).length; o < r; o++)
              (n = null),
                (c = typeof (h = e[o])) === l
                  ...
                  : "object" === c &&
                    (h instanceof jQuery && h.length && (h = h[0]),
                    h.nodeType && d.each(p)),
                n && u.push(n);
          return !1 === s ? u : t(u);
        },
        _move: function (i, s, n, o, a) {
          ...
          "boolean" == typeof s && ((a = o), (o = n), (n = s), (s = e)),
            !0 === n
              ...
              : -1 !== (i = r.stepIndex(i, s)) &&
                (i > l.stepIndex ? r._fastForward(i, h) : h.call(r, i));
        },
        _state: function (e, i) {
        ...
        _transition: function (i, s, n) {
          var l = this;
          t.isFunction(i)
            ? ((n = i), (i = l._currentState.stepIndex), (s = e))
            : t.isFunction(s) && ((n = s), (s = e));
          var h,
            c = l.options,
            u = l.step(i, s),
        ...
        _update: function (e, i) {
          ...
          (this._currentState = i),
            ...
            i.step.hasClass(n.stepClasses.unidirectional)
              ? this.elements.backward.attr("disabled", !0)
            ...
            i.step.hasClass(n.stepClasses.stop)
              ? this.elements.forward.attr("disabled", !0)
        ...
        stepIndex: function (i, n, o) {
          return arguments.length
            ? (t.isArray(i)
                ? ((o = n), (n = i[1]), (i = i[0]))
                : "boolean" == typeof n && ((o = n), (n = e)),
              (a = this.step(i, n))
                ? (o
                    ? a.siblings(s.step).andSelf()
                    : this.elements.steps
                  ).index(a)
                : -1)
      ...
      t.extend(t.validator, {
        ...
        attributeRules: function (e) {
          ...
          for (var o in t.validator.methods) {
            var a;
            "required" === o
              ? ("" === (a = s.get(0).getAttribute(o)) && (a = !0), (a = !!a))
              : (a = s.attr(o)),
              /min|max/.test(o) &&
    ...
    (s.prototype = {
      ...
      build_: function (t) {
        ...
        e &&
          ...
          "function" == typeof this.config_[this.current_].customEvent &&
            this.config_[this.current_].customEvent.call(this, t));
      },
        ...
        for (var i = 0; i < this.el_.length; ++i) {
          if (void 0 === this.selectors_[i]) {
            var s = this.extend_(
                ...
                this.defaults_,
                this.options_,
                this.el_[i].getAttribute("data-options")
              ),
              n = ":not(" + s.exclude.split(/[\s,]+/).join("):not(") + ")";
            (this.selectors_[i] = s.transform.replace(/,/g, n + ",") + n),
              (this.config_[i] = s);
          }
          var o = this.el_[i].querySelectorAll(this.selectors_[i]);
          (this.current_ = i),
            "function" == typeof t && t.call(this, this.el_[i], i);
          for (var a = 0; a < o.length; ++a)
            "function" == typeof e && e.call(this, o[a], i);
        }
      },
      onBlur_: function (t) {
      ...
      reset_: function (t) {
        ...
        if (this.hasParent_(t)) {
          ...
          i.parentNode.replaceChild(s, i),
            this.resetPlaceholder_(t),
            this.handleEvents_(t, "remove");
        }
      },
      resetFields_: function () {
        for (
          var t = this.el_[this.current_].querySelectorAll(
              this.selectors_[this.current_]
            ),
            e = 0;
          e < t.length;
          ++e
          ...
          t[e].parentNode.classList[
            this.addRemove_("SELECT" === t[e].tagName && "" !== t[e].value)
          ](this.prefixed_("is-active"));
      },
      ...
      setLabel_: function (t, e) {
        t.classList.add(this.prefixed_("label")),
          ...
          "function" == typeof this.config_[this.current_].customLabel &&
            (t.textContent = this.config_[this.current_].customLabel.call(
              this,
              t,
              e
            ));
      ...
      setPlaceholder_: function (t, e) {
        ...
        ("label" !== this.config_[this.current_].prioritize && i) ||
          (i && e.setAttribute("data-placeholder", i),
          (i = this.getLabelText_(t, e))),
          "function" == typeof this.config_[this.current_].customPlaceholder &&
            (i = this.config_[this.current_].customPlaceholder.call(
              this,
              i,
              e,
              t
          ...
          "SELECT" === e.tagName
            ? this.setSelectPlaceholder_(e, i)
      ...
      wrapLabel_: function (t, e) {
        var i = this.createEl_("div", {
          class:
            this.prefixed_("wrap") +
            " " +
            this.prefixed_("wrap-" + e.tagName.toLowerCase()),
        });
        void 0 !== e.value &&
          e.value.length &&
          i.classList.add(this.prefixed_("is-active")),
          (null !== e.getAttribute("required") ||
            e.classList.contains(this.config_[this.current_].requiredClass)) &&
            i.classList.add(this.prefixed_("is-required")),
